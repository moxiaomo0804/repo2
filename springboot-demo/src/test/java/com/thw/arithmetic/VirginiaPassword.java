...
public class VirginiaPassword {
	public static void main(String[] args) {
     String secertyCode = "CHREEVOAHMAERATBIAXXWTNXBEEOPHBSBQMQEQERBW\n" +
             ...
             "WQAIIWXNRMGWOIIFKEE";
     char[] chars = secertyCode.toCharArray();
     List<Integer> secretKeyList = getSecretKeyList(chars,chars.length);
     System.out.println(secretKeyList);
    }
